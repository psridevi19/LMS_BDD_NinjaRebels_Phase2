...
public class BatchStep{
	...
	public BatchStep(ContextUI context)
	{
	 ...
	 public void BatchUser_logged_on_to_lms_website() 
	 {
		 LoggerClass.info("BatchUser logged on LMS website");
	 }
	 
	 /* Scenario1 - Validating the Manage Batch Header */
	 @When("BatchUser Clicks on Batch button")
	 public void BatchUser_clicks_on_batch_button()
	 {    	
		// batchObj.menuBatchtab();
		 LoggerClass.info("BatchUser landed on Manage Batch page");
	 }
	 @Then("BatchUser see header text as {string}")
	 public void BatchUser_see_header_text_as(String string) 
	 {
	 ...
	 public void BatchUser_is_on_manage_batch_page() 
	 {
		// batchObj.menuBatchtab();
		 LoggerClass.info("BatchUser landed on Manage Batch page");
	 }
 	 @Then("BatchUser see Footer text as {string}")
	 public void BatchUser_see_footer_text_as(String string) 
	 {
	 ...
	 @Then("BatchUser see paginator text as {string}")
	 public void BatchUser_see_paginator_text_as(String string) 
	 {
	...
	public void BatchUser_clicks_on_enabled_paginator_next_button() 
	{
	...
	@Then("BatchUser see paginator text changed to {string}")
	public void BatchUser_see_paginator_text_changed_to(String string) 
	{
	...
	public void BatchUser_clicks_on_enabled_paginator_prev_button() 
	{
	...
	@Then("BatchUser see the text as {string}")
	public void BatchUser_see_the_text_as(String string)
	{
		if(!batchObj.validateBatchPaginator().equals("Showing 1 to 5 of 21 entries.")) 
		 {
			 LoggerClass.debug("Batch Page Paginator verification failed");
	...
	public void BatchUser_clicks_on_enabled_paginator_last_button() 
	{
	...
	@Then("BatchUser see Page number navigated to {string}")
	public void BatchUser_see_page_number_navigated_to(String string) 
	{
	...
	public void BatchUser_clicks_on_enabled_paginator_first_button() 
	{
	...
	@Then("BatchUser see Page number navigated back to {string}")
	public void BatchUser_see_page_number_navigated_back_to(String string) 
	{
	...
	@Then("BatchUser see the Search Text box has text as {string}.")
	public void BatchUser_see_the_search_text_box_has_text_as(String string)
	{
	...
	public void BatchUser_enters_batch_name_to_be_searched()
	{
	...
	public void BatchUser_enters_batch_description_to_be_searched() 
	{
	...
	public void BatchUser_enters_batch_status_to_be_searched() 
	{
	...
	public void BatchUser_enters_batch_no_of_classes_to_be_searched()
	{
	...
	public void BatchUser_enters_batch_program_name_to_be_searched()
	{
	...
	public void BatchUser_clicks_on_batch_name_ascending_arrow() 
	{
	...
	public void BatchUser_see_the_batch_name_displayed_in_ascending_order() 
	{
	...
	public void BatchUser_clicks_on_batch_description_ascending_arrow() 
	{
	...
	public void BatchUser_see_the_batch_description_displayed_in_ascending_order() 
	{	
	...
	public void BatchUser_clicks_on_batch_status_ascending_arrow() 
	{
	...
	public void BatchUser_see_the_batch_status_displayed_in_ascending_order() 
	{
	...
	public void BatchUser_clicks_on_no_of_classes_ascending_arrow()
	{
	...
	public void BatchUser_see_the_no_of_classes_displayed_in_ascending_order() 
	{
	...
	public void BatchUser_clicks_on_program_name_ascending_arrow() 
	{
	...
	public void BatchUser_see_the_program_name_displayed_in_ascending_order() 
	{
	...
	public void BatchUser_clicks_on_batch_name_descending_arrow()
	{
	...
	public void BatchUser_see_the_batch_name_displayed_in_descending_order()
	{
	...
	public void BatchUser_clicks_on_batch_description_descending_arrow()
	{
	...
	public void BatchUser_see_the_batch_description_displayed_in_descending_order() 
	{
	...
	public void BatchUser_clicks_on_batch_status_descending_arrow() 
	{
	...
	public void BatchUser_see_the_batch_status_displayed_in_descending_order() 
	{
	...
	public void BatchUser_clicks_on_no_of_classes_descending_arrow() 
	{
	...
	public void BatchUser_see_the_no_of_classes_displayed_in_descending_order() 
	{
	...
	public void BatchUser_clicks_on_program_name_descending_arrow()
	{
	...
	public void BatchUser_see_the_program_name_displayed_in_descending_order() 
	{
	...
	@Then("BatchUser counts number of rows as {int} in a table")
	public void BatchUser_counts_number_of_rows_as_in_a_table(Integer int1) 
	{
		Assert.assertEquals(int1, batchObj.noOfRowsDisplayed());
		LoggerClass.info("BatchUser counts number of rows as 5 in a table");
	}
	
	/* Scenario 33 - BatchUser Verify Added New Batch Name*/
	@When("BatchUser Enters newly added  Batch Name in Search")
	public void BatchUser_enters_newly_added_batch_name_in_search() 
	{
		batchObj.BatchDetailsSearch("SDET77");
		LoggerClass.info("BatchUser search for new Batch Name:SDET77");
	}
	...
	/* Scenario37 - BatchUser Validate Add A New Batch button  */
	@When("BatchUser Clicks on + A New Batch button")
	public void BatchUser_clicks_on_a_new_batch_button()
	{
		//batchObj.ClickAddnewBatch();
		LoggerClass.info("BatchUser Clicks on + A New Batch button");
	}
	@Then("BatchUser see a Error message {string}")
	public void BatchUser_see_a_error_message(String string) throws InterruptedException 
	{
	...
	/* Scenario 42 -BatchUser Verifys Edited Details */	
	@When("BatchUser Enters newly edited  Batch Name in Search")
	public void BatchUser_enters_newly_edited_batch_name_in_search() 
	{
		batchObj.BatchDetailsSearch("testtest1");
		LoggerClass.info("BatchUser search for newly edited Batch Name:testtest1");
	}
	...
	/* Scenario 44 - BatchUser Validate Deleted Batch Name */	
	@When("BatchUser Enters deleted Batch Name in Search")
	public void BatchUser_enters_deleted_batch_name_in_search()
	{
		batchObj.BatchDetailsSearch("AngularSDK");
		LoggerClass.info("BatchUser search for Deleted Batch Name:AngularSDK");
	}
	@Then("BatchUser finds NO records")
	public void BatchUser_finds_no_records() 
	{
		if(!batchObj.searchNewDetailsInTable("AngularSDK","Testttt","ACTIVE","99","Angular123456") == true) 
		 {
		 	...
		 	Assert.assertTrue(true);
			LoggerClass.info("BatchUser finds No records ");
	}
	
	/* Scenario 47 - BatchUser Validate First Edit button   */
	@When("BatchUser Clicks on Edit buttton")
	public void BatchUser_clicks_on_edit_buttton()
	{
		batchObj.ClickBatchEditBtn();
		LoggerClass.info("BatchUser Clicks on First Batch Edit button");
	}

	/* Scenario 51 - BatchUser Validates First Delete button  */
	@When("BatchUser Clicks on Delete buttton")
	public void BatchUser_clicks_on_delete_buttton() 
	{
		batchObj.ClickBatchDeleteBtn();
		LoggerClass.info("BatchUser Clicks on First Batch Delete button");
	}
	
	/* Scenario 58 - BatchUser Verifies Checkbox Functionality */
	@When("BatchUser Selects First checkbox left to Batch Name")
	public void BatchUser_selects_first_checkbox_left_to_batch_name()
	{
		batchObj.ClickBatchcheckbox();
		LoggerClass.info("BatchUser Clicks on First checkbox left to Batch Name");
	}
	@Then("BatchUser see all the checkboxes in the Batch page get selected")
	public void BatchUser_see_all_the_checkboxes_in_the_batch_page_get_selected() throws InterruptedException 
	{
		if(!batchObj.BatchCheckboxFunctionality() == true) 
		 {
		 	...
		 	Assert.assertTrue(true);
			LoggerClass.info("BatchUser see all the checkboxes in the Batch page get selected");
	}
	...
	public void BatchUser_see_the_delete_button_on_the_top_left_hand_side_as_disabled() 
	{
		if(!batchObj.leftDeleteBtnStatus() == false)
		 {
			LoggerClass.debug("BatchUser see the Delete button on the left as Enabled");
			Assert.assertTrue(false);
    	 }
		 	Assert.assertTrue(true);
			LoggerClass.info("BatchUser see the Delete button on the left as Disabled");
	}

	/* Scenario 53 - Validates Multiple Program Selection  */
	@When("BatchUser selects more than one Batch Name using checkbox")
	public void BatchUser_selects_more_than_one_batch_name_using_checkbox() throws InterruptedException
	{
		batchObj.ClickBatchcheckbox();
		...
		if(!batchObj.BatchCheckboxFunctionality()== true)
		 {
			LoggerClass.debug("BatchUser see the Delete button on the left as Disabled");
			Assert.assertTrue(false);
   	 }
		 	Assert.assertTrue(true);
			LoggerClass.info("BatchUser see all the checkboxes in the Batch page get selected");
	...
	public void BatchUser_see_the_delete_button_on_the_left_side_as_enabled() 
	{
		if(!batchObj.leftDeleteBtnStatus() == true)
		 {
			...
			Assert.assertTrue(false);
		 	...
		 	Assert.assertTrue(true);
			LoggerClass.info("BatchUser see the Delete button on the left as Enabled");
	}
	
	/* Scenario 57 - BatchUser Verify Deleted Batch Names */
	@When("BatchUser enters deleted batch Names in Search")
	public void BatchUser_enters_deleted_batch_names_in_search()
	{
	...
	public void BatchUser_finds_no_results()
	{
		if(!batchObj.verifyDeletedrecords("testset") == true)
		 {
			...
			Assert.assertTrue(false);
		 	...
		 	Assert.assertTrue(true);
			LoggerClass.info("BatchUser finds No results of deleted Batch names");
